...
``CS'' stands for constraint sampling (and ``CS-ideal'' when the ideal sampled proposed by \cite{CS} was used), while LRA stands for choosing the constraints based on
